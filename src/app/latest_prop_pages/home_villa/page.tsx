    ...
    <section className="max-w-6xl mx-auto px-6 mt-16 mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            <h2
              ...
              Elegant Independent Villa – Mysuru
            </h2>

            <p className="text-[#1F3A2E] mb-2 flex items-center gap-2">
              <FaMapMarkerAlt /> Vijayanagar, Mysuru
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 text-[#1F3A2E] mb-6">
              ...
              <p className="flex items-center gap-2">
                <FaTree /> Private Garden
              </p>
              <p className="flex items-center gap-2">
                <FaRulerCombined /> 2,800 sq.ft Built-up
              </p>
              <p className="flex items-center gap-2">
      ...
      <div className="mt-12 bg-white border border-[#B8A47C] rounded-xl p-10 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-[#1F3A2E]">
          <p><strong>Property Type:</strong> Independent Villa</p>
          <p><strong>Configuration:</strong> 3 BHK</p>
          <p><strong>Built-up Area:</strong> 2,800 sq.ft</p>
          <p><strong>Land Area:</strong> 2,200 sq.ft</p>
      ...
      <div className="mt-12 bg-white border border-[#B8A47C] rounded-xl p-10 shadow-sm">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 text-[#1F3A2E]">
          <p className="flex items-center gap-2"><FaSchool /> Delhi Public School – 2 km</p>
          <p className="flex items-center gap-2"><FaHospital /> Apollo Hospital – 3 km</p>
          <p className="flex items-center gap-2"><FaShoppingBag /> Mall of Mysuru – 4 km</p>
          <p className="flex items-center gap-2"><FaTrain /> Mysuru Railway Station – 5 km</p>
        </div>
      </div>
      ...
      <div className="mt-12 bg-[#FDF4E2] border border-[#B8A47C] rounded-xl p-10 shadow-md">
        ...
        <ul className="list-disc pl-5 text-[#1F3A2E] space-y-2">
          <li>Elegant design with spacious interiors</li>
          <li>Private garden for serene living</li>
          <li>Located in a peaceful residential zone</li>
          <li>Close to schools, hospitals, and shopping hubs</li>
          <li>Secure gated community lifestyle</li>
        </ul>
      </div>
