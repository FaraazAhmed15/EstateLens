  ...
  const applyFilters = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `/api/properties?location=${location}&type=${type}&budget=${budget}&bhk=${bhk}`
      )
    ...
    <div className="min-h-screen bg-[#F4F1EC]">
      ...
      <div className="pt-28 px-10 max-w-7xl mx-auto">
        ...
        <section className="mb-16 text-center">
          <h1 className="text-5xl font-bold text-[#6D1B1C] mb-4">
            Properties
          </h1>
        ...
        <section className="mb-16 bg-[#FDF4E2] border border-[#B8A47C] rounded-xl p-8 shadow-md">
          ...
          <h3 className="text-2xl font-semibold text-[#6D1B1C] mb-6">
            Filter Properties
          </h3>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              ...
              {results.map((p:any)=>(
                <div key={p.id} className="bg-white rounded-xl shadow-md p-4">
                  ...
                  <p className="text-[#6D1B1C] font-semibold">
                    {p.price}
                  </p>
