...
export default function SubscribedUserLatestProperties() {
  return (
    <section className="mb-20 relative">
      ...
      {/* scroll container */}
      <div
        className="flex gap-10 overflow-x-auto mb-4 mt-4 scroll-smooth px-14 scrollbar-hide"
      >
        {[
          {
            ...
            href: "/latest_prop_pages/luxury_residential",
          },
          {
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-[#1F3A2E] mb-2">{property.location}</p>
              <p className="text-sm text-[#1F3A2E] mb-3">{property.details}</p>
              <p className="font-semibold text-[#6D1B1C] mb-4">{property.price}</p>
